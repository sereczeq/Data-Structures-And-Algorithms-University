...
public class BST<T>
{
	...
	private Node insertRB(Node node, T elem)
	{
		...
		newNode.color = "red";
		while (nodeChange != null && nodeChange.parent.color.equalsIgnoreCase("red"))
		{
			if (nodeChange.parent == nodeChange.parent.parent.left)
			{
				Node anNode = nodeChange.parent.parent.right;
				if (anNode.color.equalsIgnoreCase("red"))
				{
					nodeChange.parent.color = "black";
					anNode.color = "Black";
					nodeChange.parent.parent.color = "red";
					nodeChange = nodeChange.parent.parent;
				}
				else
				{
					if (nodeChange == nodeChange.parent.right)
					{
						nodeChange = nodeChange.parent;
			...
			else if (nodeChange.parent == nodeChange.parent.parent.right)
			{
				Node anNode = nodeChange.parent.parent.left;
				// leftRotate(node, root.parent.parent)
				if (anNode.color.equalsIgnoreCase("red"))
				{
					nodeChange.parent.color = "black";
				...
				{
					if (nodeChange == nodeChange.parent.left)
					{
						nodeChange = nodeChange.parent;
						// rightRotate(node, root.parent.parent);
					}
